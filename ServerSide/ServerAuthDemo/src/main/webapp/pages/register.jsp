...
<script src="../scripts/register-script.js" defer></script>
</head>
<body>

	<%@ include file="/includes/navbar.jsp"%>

	<form class="container-sm py-5" id="register-form" action="<%= request.getContextPath() %>/register">
	  <div class="mb-3">
	...
	<script>
		let errorMsg = `<%= session.getAttribute("registerErrorMsg") %>`;
		if (errorMsg != 'null') {
